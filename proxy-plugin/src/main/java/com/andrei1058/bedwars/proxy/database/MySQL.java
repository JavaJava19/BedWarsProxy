...
public class MySQL implements Database{
    ...
    public boolean connect() {
        try {
            connection = DriverManager.getConnection("jdbc:mysql://" + host + ":" + port + "/" + database + "?autoReconnect=true&allowPublicKeyRetrieval=true" + "&useSSL=" + ssl + "&useUnicode=true&characterEncoding=UTF-8", user, pass);
            return true;
